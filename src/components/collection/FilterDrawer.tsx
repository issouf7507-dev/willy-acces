    ...
    <>
      ...
      >
        ...
        <div className="lg:hidden flex items-center justify-between px-5 py-4 border-b border-zinc-200">
          ...
          <button onClick={onClose} aria-label="Close filters" className="p-1.5 hover:opacity-60 transition-opacity">
        ...
        <div className="flex-1 overflow-y-auto px-5 lg:px-0">
          {/* Color */}
          <AccordionSection title="Color" defaultOpen>
          ...
          {/* Activity & Features */}
          <AccordionSection title="Activity & Features">
          ...
          {/* Weather Resistance */}
          <AccordionSection title="Weather Resistance">
            <div className="space-y-2">
          ...
          <AccordionSection title="Price">
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between text-sm text-zinc-500">
                <span>$0</span>
                <span className="font-semibold text-black">${filters.priceMax}</span>
              </div>
            </div>
          </AccordionSection>
