...
export default function Checkout() {
  ...
  // `total` du panier = montant des articles ; le client règle ce montant
  // augmenté des frais de service.
  ...
  const buildMessage = () =>
    buildWhatsappOrderMessage({
      ...
      serviceFee: { label: SERVICE_FEE_LABEL, amount: money(fee) },
          ...
          <div className="grid lg:grid-cols-[1fr_380px] gap-8 items-start">
            ...
            <form onSubmit={handleSubmit} className="bg-white border border-zinc-200 p-6 md:p-8 space-y-6 order-2 lg:order-1">
              ...
              >
                ...
                Commander sur WhatsApp — {money(grandTotal)}
              </button>
            ...
            <aside className="bg-white border border-zinc-200 p-6 order-1 lg:order-2 lg:sticky lg:top-6">
              ...
              <div className="border-t border-zinc-200 pt-4 space-y-2">
                ...
                <div className="flex items-center justify-between pt-2 border-t border-zinc-200">
                  ...
                  <span className="font-bold text-sm">{money(grandTotal)}</span>
                </div>
              </div>
